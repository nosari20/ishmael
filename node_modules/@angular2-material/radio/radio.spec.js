    ...
    testing_1.describe('MdRadioButton', function () {
        ...
        testing_1.it('should have same name as radio group', function (done) {
            builder
                ...
                var button = fixture.debugElement.query(browser_1.By.css('md-radio-button'));
        ...
        testing_1.it('updates parent group value when selected and value changed', function (done) {
            builder
                ...
                .then(function (fixture) {
                var button = fixture.debugElement.query(browser_1.By.css('md-radio-button'));
                var group = fixture.debugElement.query(browser_1.By.css('md-radio-group'));
                group.componentInstance.selected = button.componentInstance;
                fixture.detectChanges();
                testing_1.expect(group.componentInstance.value).toBe('1');
                button.componentInstance.value = '2';
                fixture.detectChanges();
                testing_1.expect(group.componentInstance.value).toBe('2');
            }).then(done);
        });
        testing_1.it('should be checked after input change event', function (done) {
            builder
                ...
                .then(function (fixture) {
                var button = fixture.debugElement.query(browser_1.By.css('md-radio-button'));
                var input = button.query(browser_1.By.css('input'));
                fixture.detectChanges();
                testing_1.expect(button.componentInstance.checked).toBe(false);
    ...
    testing_1.describe('MdRadioGroup', function () {
        ...
        testing_1.it('can select by value', function (done) {
            builder
                ...
                .createAsync(TestApp)
                .then(function (fixture) {
                var buttons = fixture.debugElement.queryAll(browser_1.By.css('md-radio-button'));
                var group = fixture.debugElement.query(browser_1.By.css('md-radio-group'));
                fixture.detectChanges();
                testing_1.expect(group.componentInstance.selected).toBe(null);
                group.componentInstance.value = '2';
                fixture.detectChanges();
                testing_1.expect(group.componentInstance.selected).toBe(buttons[1].componentInstance);
            }).then(done);
        });
        ...
        testing_1.it('should emit event when value changes', function (done) {
            builder
                ...
                testing_1.fakeAsync(function () {
                    ...
                    var group = fixture.debugElement.query(browser_1.By.css('md-radio-group'));
                    var changeEvent = null;
                    group.componentInstance.change.subscribe(function (evt) {
                        changeEvent = evt;
                    });
                    group.componentInstance.selected = buttons[1].componentInstance;
                    fixture.detectChanges();

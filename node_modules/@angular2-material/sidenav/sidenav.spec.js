 ...
 */
function createFixture(builder, template, style) {
    var fixture = null;
    ...
    builder
        ...
        .createAsync(BasicTestApp).then(function (f) { fixture = f; });
    testing_1.tick();
    return fixture;
}
    ...
    testing_1.describe('MdSidenav', function () {
        ...
        testing_1.describe('methods', function () {
            testing_1.it('should be able to open and close', fakeAsyncAdaptor(function () {
                var fixture = createFixture(builder, template, style);
            ...
            testing_1.it('open() then close() cancel animations when called too fast', fakeAsyncAdaptor(function () {
                ...
                sidenav.open().then(function (_) { openCalled = true; }, function () { openCancelled = true; });
                // We do not call transition end, close directly.
                closePromise = sidenav.close().then(function (_) { closeCalled = true; });
                endSidenavTransition(fixture);
                testing_1.tick();
            ...
            testing_1.it('close() then open() cancel animations when called too fast', fakeAsyncAdaptor(function () {
                ...
                sidenav.close().then(function (_) { closeCalled = true; }, function () { closeCancelled = true; });
                // We do not call transition end, open directly.
                sidenav.open().then(function (_) { openCalled = true; });
                endSidenavTransition(fixture);
                testing_1.tick();

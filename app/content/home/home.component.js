System.register(['angular2/core', "../../components/card/card.component", "../../components/button/button.component"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, card_component_1, button_component_1;
    var Home;
    return {
        setters:[
            function (core_1_1) {
            ...
            Home = (function () {
                ...
                Home = __decorate([
                    core_1.Component({
                        ...
                        directives: [card_component_1.Card, button_component_1.Button],
